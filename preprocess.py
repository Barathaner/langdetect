...
def preprocess(sentence, labels):
    ...
    for i in range(len(sentence)):
        ...
        processed_sentence = ' '.join(tokens) #why are we doing this? 

        # It seems as if the tokens haven't been used for anything and are
        # essentially just being thrown away in the step above. ChatGPT agrees.
