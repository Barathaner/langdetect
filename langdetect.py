...
import ssl
import nltk
# don't think these first two are necessary
...
if __name__ == "__main__":
    ...
    print('========')
    # A set just takes out duplicates 
    ...
    NB = applyNaiveBayes(X_train, y_train, X_test)
    KNN = applyKNN(X_train, y_train, X_test)
    SVM = applySVM(X_train, y_train, X_test)
    RF = applyRandomForest(X_train, y_train, X_test)
    y_predict = voting(NB, SVM, RF)
